...
include "koneksi.php";
$id = $_GET['id'];
$sql = mysqli_query($koneksi, "SELECT * FROM komentar WHERE id='$id'");
...
<div class="card card-primary">
  <div class="card-header">
    <h3 class="card-title">Edit Data komentar</h3>
  </div>
  <!-- /.card-header -->
  <!-- form start -->
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <select class="form-control" name="level">
          <option value="komentar" <?php if ($data['level'] == 'komentar') 
          echo "selected"; ?>>komentar</option>
